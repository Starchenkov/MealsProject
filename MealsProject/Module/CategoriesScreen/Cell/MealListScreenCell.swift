...
class MealListScreenCell: UITableViewCell
{
    static let indentifier = "MealScreenCell"
...
extension MealListScreenCell
{
    func set(vm: MealListCellViewModel) {
