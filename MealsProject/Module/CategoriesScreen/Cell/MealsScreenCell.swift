...
class MealScreenCell: UITableViewCell
{
    static let indentifier = "MealsScreenCell"
...
extension MealScreenCell
{
    ...
    private func makeConstraints() {
        ...
        mealCategoryLabel.snp.makeConstraints { make in
            make.top.equalTo(self.mealNameLabel.snp.bottom).offset(10)
            make.left.equalTo(self.mealImage.snp.right).offset(10)
        }
        
        mealAreaLabel.snp.makeConstraints { make in
